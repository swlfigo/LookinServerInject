...
@interface LookinInject : NSObject

@end

@implementation LookinInject
...
CHConstructor // code block that runs immediately upon load
{
	@autoreleasepool
	{
		...
		// this would be posted using: notify_post("com.isylar.LookinInject.eventname");
		CFNotificationCenterRef darwin = CFNotificationCenterGetDarwinNotifyCenter();
		CFNotificationCenterAddObserver(darwin, NULL, ExternallyPostedNotification, CFSTR("com.isylar.LookinInject.eventname"), NULL, CFNotificationSuspensionBehaviorCoalesce);
